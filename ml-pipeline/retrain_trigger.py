...
REFERENCE_DATA_PATH = Path(os.getenv("REFERENCE_DATA_PATH", "data/processed/reference.parquet"))
CURRENT_DATA_PATH = Path(os.getenv("CURRENT_DATA_PATH", "data/processed/current.parquet"))
